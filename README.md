...
The first set of features we generated were counts of the number of times each betting action (call, check, raise and bet) was performed in each of the stages of betting. 
